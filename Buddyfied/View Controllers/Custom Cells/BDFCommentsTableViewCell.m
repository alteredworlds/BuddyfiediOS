...
@interface BDFCommentsTableViewCell ()
...
@implementation BDFCommentsTableViewCell
...
- (CGSize)sizeWithData:(id)data
{
    ...
    CGSize commentsLabelSize = self.valueLabel.intrinsicContentSize;
    CGSize size = self.originalSize;
    size.width += commentsLabelSize.width - self.originalValueLabelSize.width;
    size.height += commentsLabelSize.height - self.originalValueLabelSize.height;
